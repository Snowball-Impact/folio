...
<svelte:head>
	<title>FOLIO | 데이터 시각화 커뮤니티</title>
	<meta
		name="description"
		content="올리면 만나요, 폴리오. 좋은 데이터 시각화 프로젝트를 발견하고 직접 경험하는 커뮤니티"
	/>
	...
	<meta
		...
		content="올리면 만나요, 폴리오. 좋은 데이터 시각화 프로젝트를 발견하고 직접 경험하는 커뮤니티"
	/>
	<meta property="og:image" content="https://folio.it.kr/og.png" />
	...
	<meta
		...
		content="올리면 만나요, 폴리오. 좋은 데이터 시각화 프로젝트를 발견하고 직접 경험하는 커뮤니티"
	/>
	<meta name="twitter:image" content="https://folio.it.kr/og.png" />
</svelte:head>
