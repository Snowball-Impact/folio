...
function contentSecurityPolicy(options: SecurityHeaderOptions) {
	...
	const directives = [
		...
		['frame-src', ...uniqueSources([...FRAME_SOURCES, ...normalizeFrameSources(options.frameSources)])],
		['child-src', ...uniqueSources([...FRAME_SOURCES, ...normalizeFrameSources(options.frameSources)])],
