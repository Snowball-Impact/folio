...
_HOME_HERO_SLIDES = (
    {
        ...
        "body": "FOLIO는 좋은 시각화를 발견하고, 직접 경험하며 토론하고 함께 성장하는 커뮤니티입니다.",
    ...
    },
    {
        ...
        "body": "각자의 시각화 경험을 나누고, 댓글과 피드백으로 더 나은 관점을 만들어갑니다.",
        "break_body_at_comma": True,
        "visual": "guide",
        "cta": "내 프로젝트 등록하기",
    },
    {
        ...
        "body": "PBIX 파일을 간편하게 게시하고, 누구나 열어볼 수 있는 보고서 페이지로 프로젝트를 공유합니다.",
        "break_body_at_comma": True,
        "visual": "powerbi",
    ...
    },
    {
        ...
        "body": "스터디 클럽에서 함께 실습하고, 보고서 디자인과 DAX, 경영정보시각화 실기를 토론하며 성장합니다.",
        "break_body_at_comma": True,
        "visual": "study",
        "cta": "스터디 클럽 참여하기",
