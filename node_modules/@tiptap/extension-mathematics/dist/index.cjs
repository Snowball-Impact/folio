...
* })
*/
const BlockMath = _tiptap_core.Node.create({
	name: "blockMath",
	group: "block",
	atom: true,
	addOptions() {
	...
	renderHTML({ HTMLAttributes }) {
		return ["div", (0, _tiptap_core.mergeAttributes)(HTMLAttributes, { "data-type": "block-math" })];
	},
	parseMarkdown: (token) => {
		return {
			type: "blockMath",
	...
	addNodeView() {
		...
		return ({ node, getPos }) => {
			...
			function renderMath() {
				try {
					katex.default.render(node.attrs.latex, innerWrapper, katexOptions);
...
* })
*/
const InlineMath = _tiptap_core.Node.create({
	name: "inlineMath",
	group: "inline",
	inline: true,
	atom: true,
	...
	renderHTML({ HTMLAttributes }) {
		return ["span", (0, _tiptap_core.mergeAttributes)(HTMLAttributes, { "data-type": "inline-math" })];
	},
	parseMarkdown: (token) => {
		return {
			type: "inlineMath",
	...
	addNodeView() {
		...
		return ({ node, getPos }) => {
			...
			function renderMath() {
				try {
					katex.default.render(node.attrs.latex, wrapper, katexOptions);
...
* ```
*/
const Mathematics = _tiptap_core.Extension.create({
	name: "Mathematics",
	addOptions() {
		return {
...
exports.createMathMigrateTransaction = createMathMigrateTransaction;
exports.default = src_default;
exports.mathMigrationRegex = mathMigrationRegex;
exports.migrateMathStrings = migrateMathStrings;
